...
namespace Celeste.Mod.ConsistencyTracker.Models {
    ...
    public class RoomStats {
        ...
        public override string ToString() {
            ...
            return
                $"{DebugRoomName};{GoldenBerryDeaths};{GoldenBerryDeathsSession};{LastFiveRate};{LastTenRate};{LastTwentyRate};{MaxRate};{attemptList}";
        }
        ...
        public static RoomStats ParseString(string line) {
            ...
            var attemptList = (from boolStr in attemptListString.Split(',')
                               where boolStr.Trim() != ""
                               select bool.Parse(boolStr)).ToList();
