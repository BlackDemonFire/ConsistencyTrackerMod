...
namespace Celeste.Mod.ConsistencyTracker.Stats
{
    ...
    public class SuccessRateStat : Stat
    {
        ...
        public static List<string> IDs =
            new() { RoomSuccessRate, CheckpointSuccessRate, ChapterSuccessRate };
        ...
        public override List<KeyValuePair<string, string>> GetPlaceholderExplanations()
        {
            return new List<KeyValuePair<string, string>>()
            {
                new KeyValuePair<string, string>(
                    RoomSuccessRate,
                    "Current room's success rate (count of successful attempts / total attempts)"
                ),
                new KeyValuePair<string, string>(
                    CheckpointSuccessRate,
                    "Current checkpoint's success rate"
                ),
        ...
        public override List<StatFormat> GetStatExamples()
        {
            return new List<StatFormat>()
            {
                new StatFormat(
                    "success-rate",
                    $"Room SR: {RoomSuccessRate} | CP: {CheckpointSuccessRate} | Total: {ChapterSuccessRate}"
                )
            };
        }
    }
