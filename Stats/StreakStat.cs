...
public class StreakStat : Stat {
    ...
    public static List<string> IDs = new() { RoomCurrentStreak, CheckpointCurrentStreak, ListRoomStreaks };
    ...
    public override List<KeyValuePair<string, string>> GetPlaceholderExplanations() {
        return new List<KeyValuePair<string, string>>() {
            new(RoomCurrentStreak, "Current streak of beating the current room deathless"),
            new(CheckpointCurrentStreak, "Current streak of beating the current checkpoint deathless"),
        };
    }
    public override List<StatFormat> GetStatExamples() {
        return new List<StatFormat>() {
            new("current-streak", $"Current Room Streak: {RoomCurrentStreak}, Checkpoint: {CheckpointCurrentStreak}")
        };
    }
}