...
namespace Celeste.Mod.ConsistencyTracker.Stats {
    ...
    public class ListCheckpointDeathsStat : Stat {
        ...
        public static List<string> IDs = new List<string>() { ListCheckpointDeaths };
        ...
        public override string FormatStat(PathInfo chapterPath, ChapterStats chapterStats, string format) {
            ...
            var checkpointDeaths = chapterPath.Checkpoints.Select(cpInfo =>
                cpInfo.Rooms.Sum(rInfo => chapterStats.GetRoom(rInfo.DebugRoomName).DeathsInCurrentRun)).ToList();
        ...
        public override List<KeyValuePair<string, string>> GetPlaceholderExplanations() {
            ...
            {
                new KeyValuePair<string, string>(ListCheckpointDeaths,
                    "Lists death count for each checkpoint in the current run (for low deaths, like '0/0/2/3/0/1')"),
            };
        }
