...
namespace Celeste.Mod.ConsistencyTracker {
    ...
    public class ConsistencyTrackerSettings : EverestModuleSettings {
        ...
        public void CreateOnlyTrackWithGoldenBerryEntry(TextMenu menu) {
            menu.Add(new TextMenu.OnOff("Only Track Deaths With Golden Berry", OnlyTrackWithGoldenBerry) {
                OnValueChange = v => { OnlyTrackWithGoldenBerry = v; }
            });
        }
        ...
        public void CreateWipeChapterEntry(TextMenu menu, bool inGame) {
            ...
            subMenu.Add(new TextMenu.Button("Remove Last Attempt") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.RemoveLastAttempt(); }
            });

            subMenu.Add(new TextMenu.Button("Remove Last Death Streak") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.RemoveLastDeathStreak(); }
            });

            subMenu.Add(new TextMenu.Button("Remove All Attempts") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.WipeRoomData(); }
            });

            subMenu.Add(new TextMenu.Button("Remove Golden Berry Deaths") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.RemoveRoomGoldenBerryDeaths(); }
            });


            subMenu.Add(new TextMenu.SubHeader("Current Chapter"));
            subMenu.Add(new TextMenu.Button("Reset All Attempts") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.WipeChapterData(); }
            });

            subMenu.Add(new TextMenu.Button("Reset All Golden Berry Deaths") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.WipeChapterGoldenBerryDeaths(); }
            });
        ...
        public void CreateCreateSummaryEntry(TextMenu menu, bool inGame) {
            ...
            subMenu.Add(
                new TextMenu.SubHeader("Outputs some cool data of the current chapter in a readable .txt format"));
            ...
            subMenu.Add(new TextMenuExt.EnumerableSlider<int>("Summary Over X Attempts", attemptCounts,
                SummarySelectedAttemptCount) {
                OnValueChange = (value) => { SummarySelectedAttemptCount = value; }
            });
        ...
        //Types: 1 -> EH-3 | 2 -> Event-Horizon-3
        [SettingIgnore] public ListFormat LiveDataListOutputFormat { get; set; } = ListFormat.Json;

        [SettingIgnore] public bool LiveDataHideFormatsWithoutPath { get; set; } = false;

        [SettingIgnore] public bool LiveDataIgnoreUnplayedRooms { get; set; } = false;
        ...
        public void CreateLiveDataEntry(TextMenu menu, bool inGame) {
            ...
            subMenu.Add(new TextMenuExt.EnumerableSlider<int>("Max. Decimal Places", digitCounts, LiveDataDecimalPlaces) {
                OnValueChange = (value) => { LiveDataDecimalPlaces = value; }
            });


            subMenu.Add(new TextMenu.SubHeader(
            ...
            subMenu.Add(new TextMenuExt.EnumerableSlider<int>("Consider Last X Attempts", attemptCounts,
                LiveDataSelectedAttemptCount) {
                OnValueChange = (value) => { LiveDataSelectedAttemptCount = value; }
            });


            subMenu.Add(
                new TextMenu.SubHeader("Whether you want checkpoint names to be full or abbreviated in the room name"));
            ...
            subMenu.Add(
                new TextMenuExt.EnumerableSlider<int>("Room Name Format", PBNameTypes, (int)LiveDataRoomNameDisplayType) {
                    OnValueChange = (value) => { LiveDataRoomNameDisplayType = (RoomNameDisplayType)value; }
                });
            ...
            subMenu.Add(
                new TextMenuExt.EnumerableSlider<int>("List Output Format", listTypes, (int)LiveDataListOutputFormat) {
                    OnValueChange = (value) => { LiveDataListOutputFormat = (ListFormat)value; }
                });
            ...
            subMenu.Add(new TextMenu.OnOff("Hide Formats When No Path", LiveDataHideFormatsWithoutPath) {
                OnValueChange = v => { LiveDataHideFormatsWithoutPath = v; }
            });
            ...
            subMenu.Add(new TextMenu.OnOff("Ignore Unplayed Rooms", LiveDataIgnoreUnplayedRooms) {
                OnValueChange = v => { LiveDataIgnoreUnplayedRooms = v; }
            });
            ...
            subMenu.Add(new TextMenu.Button("Reload format file") {
                OnPressed = () => { ConsistencyTrackerModule.Instance.StatsManager.LoadFormats(); }
            });
    ...
    public static class OverlayPositionExtensions {
        public static bool IsHorizontal(this OverlayPosition self) =>
            self == OverlayPosition.Top || self == OverlayPosition.Bottom;

        public static bool IsVertical(this OverlayPosition self) =>
            self is OverlayPosition.Left || self == OverlayPosition.Right;
    }
}