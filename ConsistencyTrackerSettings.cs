...
namespace Celeste.Mod.ConsistencyTracker
{
    public class ConsistencyTrackerSettings : EverestModuleSettings
    {
        ...
        public void CreateRecordPathEntry(TextMenu menu, bool inGame)
        {
            ...
            var pathRecordingToggle = new TextMenu.OnOff(
                "Record Path",
                ConsistencyTrackerModule.Instance.DoRecordPath
            )
            {
                OnValueChange = v =>
                {
        ...
        public void CreateCreateSummaryEntry(TextMenu menu, bool inGame)
        {
            ...
            TextMenuExt.EnumerableSlider<int> attemptSlider = new TextMenuExt.EnumerableSlider<int>(
    ...
    public static class OverlayPositionExtensions
    {
        ...
        public static bool IsVertical(this OverlayPosition self) =>
            self == OverlayPosition.Left || self == OverlayPosition.Right;
    }
}
